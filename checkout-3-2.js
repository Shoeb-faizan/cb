...
const payInstallments = () =>{
    ...
    let customer = {first_name: userData.firstname, last_name: userData.lastname, email: userData.email, phone:phoneChargebee, billing_address:{first_name: userData.firstname[0].toUpperCase() + userData.firstname.substring(1), last_name: userData.lastname[0].toUpperCase() + userData.lastname.substring(1), email:userData.email.toLowerCase(), country: locationObj.location.country.toUpperCase(), phone: phoneChargebee, zip:locationObj.location.postal, city:locationObj.location.city}};
...
const userDetailsForm = () => {
    ...
    // Making Checkout Mobile Field Location Aware
    ...
    const removeClass = (arr, classStr) => {
        ...
        if(scholarshipCheckbox){
            scholarshipCheckbox.addEventListener('click', function(){
                ...
                //    alert(paymentData.userSelectedScholarship)
                }
...
const getEmi = (curr) => {
    ...
    //installmentSale if true all visible
...
const defaultForm = (curr = 'gbp') => {
    ...
    <div class="paymentType" id="paymentType">
                ...
                ${scholarshipOffer ? `<div id="customMessage">
                ...
                <label for="full">
                    <div class="payFull green" id="payFull">
                        ...
                        <div class="priceBox clearfix" id="payFullPrice">
                ...
                ${installment ? `<label for="Installment">
                    <div class="payininstallments" id="payininstallments">
                        ...
                        <div class="priceBox clearfix" id="payEmi">
                ...
                <label for="ansar">
                    <div class="payAnsar" id="payAnsar">
                        ...
                        <div class="priceBox clearfix" id="payAnsarPrice">
...
`;
    ...
    //iv scholarship is true
    if (scholarshipOffer) { canPayFull(); }
